...
export const SCAN_URL_ID: Record<number, string> = {
...
export const DEX_URL_ID: Record<number, string> = {
    1: "https://app.uniswap.org/swap?chain=mainnet&inputCurrency=NATIVE&outputCurrency=",
    97: "https://pancakeswap.finance/swap?chain=bscTestnet&inputCurrency=tBNB&outputCurrency=",
  };
